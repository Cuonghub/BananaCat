...
Button.Image = "rbxassetid://133149265091157"
...
Tabs.Info:AddButton({
        ...
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/RGZbjt8P")) 
        end
})
Tabs.Info:AddButton({
    Title="Mcuonghub",
    Description="Tiktok",
    Callback=function()
        setclipboard(tostring("https://www.tiktok.com/@cuonghub03?lang=id-ID"))
    end
})
Tabs.Info:AddButton({
    Title="Ma Cường (M T C)",
    Description="Facebook",
    Callback=function()
        setclipboard(tostring("https://m.facebook.com/ma.cuong.442807/"))
    end
})
...
Tabs.Info:AddParagraph({
    Title="Update",
    Content="Script supports pc and android"
})
Tabs.Info:AddParagraph({
...
_G.FastAttackVxeze_Mode="Xeter Attack"
spawn(function()
    while wait() do
        if _G.FastAttackVxeze_Mode then
            pcall(function()
                if _G.FastAttackVxeze_Mode=="Xeter Attack" then
